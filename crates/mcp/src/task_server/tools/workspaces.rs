...
struct McpWaitExecutionRequest {
    ...
    #[schemars(
        description = "Maximum time to wait in seconds before returning a timeout response (default: 1800). If your MCP harness times out first, call again with the same IDs and the remaining intended wait budget, e.g. 900 - 120 = 780."
    )]

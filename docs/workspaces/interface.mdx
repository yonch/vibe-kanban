...
The top navigation bar surfaces quick actions for the current workspace:

| Icon | Action | Description |
|:----:|--------|-------------|
| *IDE logo* | Open in IDE | Launch the workspace in your configured editor (icon shows your IDE). |
| <Icon icon="copy" /> | Copy Path | Copy the workspace path to the clipboard. |
